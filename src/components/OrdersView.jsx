...
const OrdersView = () => {
    ...
    return (
        <div className='bg-red-500  container mx-auto my-6 pt-6 relative min-h-[100vh] flex flex-col items-center '>

        <div className='flex flex-col container bg-slate-500 p-2'>
