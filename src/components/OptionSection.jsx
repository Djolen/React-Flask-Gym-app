  ...
  return (
    <div className='container relative mx-auto mb-2 flex flex-col-reverse items-center justify-between md:flex-row'>
        <div className='min-w-[50%] flex items-center justify-center mx-auto' >
            <img  className="max-w-11" src={secondLogo} alt="logo" />
        </div>

        <div className="container flex flex-col max-w-[50%]">
            <div className=" bg-teal-900/[0.8] my-12 p-8 drop-shadow-lg text-center">
            ...
            <div className=" bg-teal-800/[0.8]  my-12 p-8 drop-shadow-lg text-center">
            ...
            <div className="bg-teal-700/[0.8]  my-12 p-8 drop-shadow-lg text-center ">
